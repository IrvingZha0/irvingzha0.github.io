        ...
        $('#myCarousel')
            .on('slid.bs.carousel', function () {
                if ($('.item.active').hasClass('car-item-1')) {
                    ...
                    $('.carousel-desc_content').text('Promoting partnerships and collaborations among entities, private or public usi' +
                            'ng the FISCO BCOS platform.');
                }
                ...
                if ($('.item.active').hasClass('car-item-3')) {
                    ...
                    $('.carousel-desc_content').text('Guangzhou Arbitration Commission, WeBank, and Hangzhou Yibi' +
                            ' the "arbitration blockchain"');
                }
